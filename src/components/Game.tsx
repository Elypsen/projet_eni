...
const Game = () => {
    ...
    return(
        ...
        <form>
            <div>
                <label htmlFor="number">Enter a number to find the hidden one : </label>
                <input type="number" name="number" id="number" defaultValue={number} value={number} onChange={(e) => {setNumber(e.target.value)}} />
            </div>
